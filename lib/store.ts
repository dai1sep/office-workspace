...
const seedState: AppState = {
  ...
  schedules: [
    ...
    { id: "s_term_dl1", title: "田辺邸新築工事（工期）", date: "2026-06-01", endDate: "2026-09-30", start: "08:00", end: "17:00", allDay: true, location: "大阪市住吉区", members: ["u1", "u2", "u4"], type: "work", detail: "案件パイプラインの工期から自動反映", workspaceId: "ws1", scheduleMode: "multiDay" },
  ],
  bulletins: [
  ...
  customers: [
    { id: "c1", name: "田辺 花子", kind: "民間", contact: "田辺", phone: "090-1111-2222" },
    { id: "c2", name: "山田不動産", kind: "民間", contact: "山田 太郎", phone: "06-3333-4444" },
    { id: "c3", name: "神戸建設サービス", kind: "民間", contact: "佐藤" },
